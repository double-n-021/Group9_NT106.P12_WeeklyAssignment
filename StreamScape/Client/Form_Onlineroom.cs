...
namespace Client
{
    public partial class Form_Onlineroom : Form
    {
        ...
        #region Chức năng load data từ DB của server về cho form onlineroom...
        ...
        #region Xem userList trong Room
        int count = 0;
